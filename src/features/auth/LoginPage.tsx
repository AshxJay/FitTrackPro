        ...
        <div style={{ width: '100%', maxWidth: 380 }}>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
            ...
            <button
              ...
              style={{ width: '100%', padding: '13px', borderRadius: 10, border: 'none', cursor: 'pointer', fontFamily: 'Syne,sans-serif', fontSize: 14, fontWeight: 700, letterSpacing: '0.3px', background: loading ? 'rgba(124,92,252,0.4)' : 'linear-gradient(135deg,var(--violet),#5a3fd4)', color: '#fff', transition: 'all 0.2s', boxShadow: loading ? 'none' : '0 4px 24px rgba(124,92,252,0.35)' }}
            >
          ...
          <button
            onClick={() => { setLoading(true); setTimeout(() => setAuthenticated(true), 700); }}
            style={{ width: '100%', padding: '13px', borderRadius: 10, border: '1px solid rgba(255,255,255,0.1)', cursor: 'pointer', background: 'rgba(255,255,255,0.04)', color: 'var(--txt)', fontSize: 14, fontFamily: 'DM Sans,sans-serif', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10, transition: 'all 0.2s' }}
          >
